...
public class WomanController : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag == "Defeat" ||
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Debug.Log("woman Trigger " + other.gameObject.tag + "pos (" + pos.x + ", " + pos.y + ", " + pos.z + "), ang (" + ang.x + ", " + ang.y + ", " + ang.z + ") state " + state);
        ...
        else if (other.gameObject.tag == "WomanItem")
        {
            Destroy(other.gameObject);
        }
        Debug.Log("woman state " + state.ToString());
    }
}
